...
CMD ["sh", "-c", "pnpx prisma generate --schema prisma/master.prisma && pnpx prisma generate --schema prisma/slave.prisma && pnpx ts-node-dev --watch --respawn --transpile-only --poll -r tsconfig-paths/register src/main.ts"]
