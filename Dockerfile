...
CMD ["sh", "-c", "pnpx prisma generate --schema prisma/master.prisma && pnpx prisma generate --schema prisma/slave.prisma && ts-node-dev --respawn --transpile-only src/main.ts"]
